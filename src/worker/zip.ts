...
/**
 * Create a stored ZIP using data descriptors. Each source stream is copied
 * into the output as it is read; only the small central directory is retained
 * in Worker memory. This keeps large originals out of arrayBuffer()/Buffer.
 */

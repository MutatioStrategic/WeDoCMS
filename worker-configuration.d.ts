/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a73993ca6efccf3a282054db6d0382a)
...
interface __BaseEnv_Env {
	...
	PHOTO_ENRICHMENT_QUEUE: Queue;
	ZOHO_INTEGRATION_QUEUE: Queue;
	STREAM_WEBHOOK_SECRET_STORE: SecretsStoreSecret;
	STREAM_API_TOKEN_STORE: SecretsStoreSecret;
	AI: Ai;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	APP_ENV: "demo" | "production" | "development";
	DEMO_AUTH_ENABLED?: "true";
	ALLOWED_ORIGINS: "https://veld-archive.pages.dev,https://veld-archive-api-demo.blewisorlando.workers.dev,http://localhost:5173,http://127.0.0.1:5173" | "https://veld-archive.pages.dev" | "http://localhost:5173,http://127.0.0.1:5173,http://localhost:8081,http://127.0.0.1:8081,http://localhost:8787,http://127.0.0.1:8787";
	TURNSTILE_HOSTNAMES: "veld-archive.pages.dev,veld-archive-api-demo.blewisorlando.workers.dev,localhost,127.0.0.1" | "veld-archive.pages.dev" | "localhost,127.0.0.1";
	DEFAULT_ORGANIZATION_ID: "org-demo" | "org-production";
	AUTH_ALLOW_ORG_PROVISIONING?: "false";
	RATE_LIMIT_WINDOW_SECONDS: "60";
	RATE_LIMIT_DEFAULT_PER_WINDOW: "120";
	UPLOAD_DAILY_QUOTA_BYTES: "50000000000";
	ORG_STORAGE_QUOTA_BYTES: "500000000000";
	MEDIA_SCANNER_URL: "";
	R2_BUCKET_NAME: "veld-archive-demo-media" | "veld-archive-media";
	R2_DR_BUCKET_NAME: "veld-archive-demo-media-dr" | "veld-archive-media-dr";
	BACKUP_BUCKET_NAME: "veld-archive-demo-backups" | "veld-archive-backups" | "veld-archive-backups-dr";
	R2_ACCOUNT_ID?: "37e92dc58245d6eab6517a916bd4d9d6";
	CHAOS_TESTING_ENABLED: "false";
	AUTH_JWKS_URL: "https://dev-irn8jgmlsiudjo2l.us.auth0.com/.well-known/jwks.json";
	AUTH_ISSUER: "https://dev-irn8jgmlsiudjo2l.us.auth0.com/";
	UPLOAD_MAX_SIZE_BYTES: "30000000000";
	AUDIT_SIGNING_KEY_ID: "audit-ed25519-v1";
	AUDIT_RETENTION_DAYS: "2555";
	AUDIT_ALLOWED_RESIDENCIES: "za,eu";
	KYC_PROVIDER: "" | "replace-with-your-kyc-provider";
	DIDIT_KYC_WORKFLOW_ID: "";
	DIDIT_KYB_WORKFLOW_ID: "";
	DIDIT_API_URL: "https://verification.didit.me/v3/session/";
	APP_PUBLIC_URL: "https://veld-archive-api-demo.blewisorlando.workers.dev" | "https://veld-archive.pages.dev";
	CIPC_LOOKUP_URL: "";
	OCR_ENABLED: "false";
	OCR_MODEL: "@cf/moondream/moondream3.1-9B-A2B";
	PHOTO_VISION_MODEL: "@cf/moondream/moondream3.1-9B-A2B";
	PHOTO_EMBEDDING_MODEL: "@cf/baai/bge-base-en-v1.5";
	PHOTO_INDEX_NAMESPACE: "demo-published-photos-v1" | "published-photos-v1";
	PHOTO_AI_SOURCE_ORIGIN?: "" | "https://veld-archive-api.blewisorlando.workers.dev";
	PHOTO_VISION_PROVIDER?: "" | "ollama-tunnel";
	REMOTE_VISION_URL?: "" | "https://veld-vision.mutatiostrategic.io/api/generate";
	TRENDING_SEARCH_MIN_COUNT: "3";
	PAYOUT_MIN_CENTS: "10000";
	DEFAULT_ARTIST_SHARE_PERCENTAGE: "60";
	PAYSTACK_SPLIT_FEE_BEARER: "account";
	PAYSTACK_SUBSCRIPTION_PLAN_CODE: "demo-monthly" | "PLN_aoo1xazr02olbru";
	PAYSTACK_ANNUAL_SUBSCRIPTION_PLAN_CODE: "demo-annual" | "";
	BUYER_SUBSCRIPTION_AMOUNT_CENTS: "120000";
	BUYER_ANNUAL_SUBSCRIPTION_AMOUNT_CENTS: "1200000";
	BUYER_SUBSCRIPTION_INTERVAL: "monthly";
	INTRODUCTORY_FREE_DOWNLOAD_LIMIT: "3";
	MARKETPLACE_TERMS_APPROVED: "false";
	EDGE_CONTROLS_ATTESTED_AT: "";
	KEY_ROTATION_ATTESTED_AT: "";
	BACKUP_RESTORE_ATTESTED_AT: "";
	PAYMENT_PROVIDER: "demo" | "paystack";
	PAYMENT_ENDPOINT: "" | "https://api.paystack.co/transaction/initialize";
	STREAM_ACCOUNT_ID: "37e92dc58245d6eab6517a916bd4d9d6";
	STREAM_ALLOWED_ORIGINS: "https://veld-archive.pages.dev,https://veld-archive-api-demo.blewisorlando.workers.dev" | "https://veld-archive.pages.dev";
	SESSION_SECRET?: string;
	AUTH_COOKIE_DOMAIN?: "veld-archive.pages.dev";
	AUTH_PROVIDER?: "both";
	SUPABASE_URL?: "https://fmqwymgmrkrnfkugogbw.supabase.co";
	SUPABASE_AUDIENCE?: "authenticated";
	AUTH_AUDIENCE?: "https://veld-archive-api.blewisorlando.workers.dev";
...
declare namespace Cloudflare {
	...
	interface DemoEnv {
		...
		APP_ENV: "demo";
		DEMO_AUTH_ENABLED: "true";
		ALLOWED_ORIGINS: "https://veld-archive.pages.dev,https://veld-archive-api-demo.blewisorlando.workers.dev,http://localhost:5173,http://127.0.0.1:5173";
		TURNSTILE_HOSTNAMES: "veld-archive.pages.dev,veld-archive-api-demo.blewisorlando.workers.dev,localhost,127.0.0.1";
		...
		ORG_STORAGE_QUOTA_BYTES: "500000000000";
		MEDIA_SCANNER_URL: "";
		R2_BUCKET_NAME: "veld-archive-demo-media";
		R2_DR_BUCKET_NAME: "veld-archive-demo-media-dr";
		BACKUP_BUCKET_NAME: "veld-archive-demo-backups";
		R2_ACCOUNT_ID: "37e92dc58245d6eab6517a916bd4d9d6";
		CHAOS_TESTING_ENABLED: "false";
		AUTH_JWKS_URL: "https://dev-irn8jgmlsiudjo2l.us.auth0.com/.well-known/jwks.json";
		AUTH_ISSUER: "https://dev-irn8jgmlsiudjo2l.us.auth0.com/";
		...
		DIDIT_KYB_WORKFLOW_ID: "";
		DIDIT_API_URL: "https://verification.didit.me/v3/session/";
		APP_PUBLIC_URL: "https://veld-archive-api-demo.blewisorlando.workers.dev";
		CIPC_LOOKUP_URL: "";
		OCR_ENABLED: "false";
		OCR_MODEL: "@cf/moondream/moondream3.1-9B-A2B";
		PHOTO_VISION_MODEL: "@cf/moondream/moondream3.1-9B-A2B";
		PHOTO_EMBEDDING_MODEL: "@cf/baai/bge-base-en-v1.5";
		PHOTO_INDEX_NAMESPACE: "demo-published-photos-v1";
		PHOTO_AI_SOURCE_ORIGIN: "";
		PHOTO_VISION_PROVIDER: "";
		REMOTE_VISION_URL: "";
		TRENDING_SEARCH_MIN_COUNT: "3";
		PAYOUT_MIN_CENTS: "10000";
		DEFAULT_ARTIST_SHARE_PERCENTAGE: "60";
		PAYSTACK_SPLIT_FEE_BEARER: "account";
		PAYSTACK_SUBSCRIPTION_PLAN_CODE: "demo-monthly";
		PAYSTACK_ANNUAL_SUBSCRIPTION_PLAN_CODE: "demo-annual";
		BUYER_SUBSCRIPTION_AMOUNT_CENTS: "120000";
		BUYER_ANNUAL_SUBSCRIPTION_AMOUNT_CENTS: "1200000";
		BUYER_SUBSCRIPTION_INTERVAL: "monthly";
		...
		PAYMENT_ENDPOINT: "";
		STREAM_ACCOUNT_ID: "37e92dc58245d6eab6517a916bd4d9d6";
		STREAM_ALLOWED_ORIGINS: "https://veld-archive.pages.dev,https://veld-archive-api-demo.blewisorlando.workers.dev";
		SESSION_SECRET: string;
	}
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "production";
		ALLOWED_ORIGINS: "https://veld-archive.pages.dev";
		TURNSTILE_HOSTNAMES: "veld-archive.pages.dev";
		AUTH_COOKIE_DOMAIN: "veld-archive.pages.dev";
		AUTH_PROVIDER: "both";
		SUPABASE_URL: "https://fmqwymgmrkrnfkugogbw.supabase.co";
		SUPABASE_AUDIENCE: "authenticated";
		AUTH_ALLOW_ORG_PROVISIONING: "false";
		DEFAULT_ORGANIZATION_ID: "org-production";
		RATE_LIMIT_WINDOW_SECONDS: "60";
		RATE_LIMIT_DEFAULT_PER_WINDOW: "120";
		UPLOAD_DAILY_QUOTA_BYTES: "50000000000";
		ORG_STORAGE_QUOTA_BYTES: "500000000000";
		...
		R2_DR_BUCKET_NAME: "veld-archive-media-dr";
		BACKUP_BUCKET_NAME: "veld-archive-backups";
		CHAOS_TESTING_ENABLED: "false";
		AUTH_JWKS_URL: "https://dev-irn8jgmlsiudjo2l.us.auth0.com/.well-known/jwks.json";
		AUTH_ISSUER: "https://dev-irn8jgmlsiudjo2l.us.auth0.com/";
		AUTH_AUDIENCE: "https://veld-archive-api.blewisorlando.workers.dev";
		...
		DIDIT_KYB_WORKFLOW_ID: "";
		DIDIT_API_URL: "https://verification.didit.me/v3/session/";
		APP_PUBLIC_URL: "https://veld-archive.pages.dev";
		CIPC_LOOKUP_URL: "";
		OCR_ENABLED: "false";
		OCR_MODEL: "@cf/moondream/moondream3.1-9B-A2B";
		PHOTO_VISION_MODEL: "@cf/moondream/moondream3.1-9B-A2B";
		...
		DEFAULT_ARTIST_SHARE_PERCENTAGE: "60";
		PAYSTACK_SPLIT_FEE_BEARER: "account";
		PAYSTACK_SUBSCRIPTION_PLAN_CODE: "PLN_aoo1xazr02olbru";
		PAYSTACK_ANNUAL_SUBSCRIPTION_PLAN_CODE: "";
		BUYER_SUBSCRIPTION_AMOUNT_CENTS: "120000";
		BUYER_ANNUAL_SUBSCRIPTION_AMOUNT_CENTS: "1200000";
		BUYER_SUBSCRIPTION_INTERVAL: "monthly";
		INTRODUCTORY_FREE_DOWNLOAD_LIMIT: "3";
		...
		PAYMENT_ENDPOINT: "https://api.paystack.co/transaction/initialize";
		STREAM_ACCOUNT_ID: "37e92dc58245d6eab6517a916bd4d9d6";
		STREAM_ALLOWED_ORIGINS: "https://veld-archive.pages.dev";
		R2_ACCESS_KEY_ID: string;
		R2_SECRET_ACCESS_KEY: string;
		REMOTE_VISION_TOKEN: string;
		SESSION_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "DEMO_AUTH_ENABLED" | "ALLOWED_ORIGINS" | "TURNSTILE_HOSTNAMES" | "DEFAULT_ORGANIZATION_ID" | "AUTH_ALLOW_ORG_PROVISIONING" | "RATE_LIMIT_WINDOW_SECONDS" | "RATE_LIMIT_DEFAULT_PER_WINDOW" | "UPLOAD_DAILY_QUOTA_BYTES" | "ORG_STORAGE_QUOTA_BYTES" | "MEDIA_SCANNER_URL" | "R2_BUCKET_NAME" | "R2_DR_BUCKET_NAME" | "BACKUP_BUCKET_NAME" | "R2_ACCOUNT_ID" | "CHAOS_TESTING_ENABLED" | "AUTH_JWKS_URL" | "AUTH_ISSUER" | "UPLOAD_MAX_SIZE_BYTES" | "AUDIT_SIGNING_KEY_ID" | "AUDIT_RETENTION_DAYS" | "AUDIT_ALLOWED_RESIDENCIES" | "KYC_PROVIDER" | "DIDIT_KYC_WORKFLOW_ID" | "DIDIT_KYB_WORKFLOW_ID" | "DIDIT_API_URL" | "APP_PUBLIC_URL" | "CIPC_LOOKUP_URL" | "OCR_ENABLED" | "OCR_MODEL" | "PHOTO_VISION_MODEL" | "PHOTO_EMBEDDING_MODEL" | "PHOTO_INDEX_NAMESPACE" | "PHOTO_AI_SOURCE_ORIGIN" | "PHOTO_VISION_PROVIDER" | "REMOTE_VISION_URL" | "TRENDING_SEARCH_MIN_COUNT" | "PAYOUT_MIN_CENTS" | "DEFAULT_ARTIST_SHARE_PERCENTAGE" | "PAYSTACK_SPLIT_FEE_BEARER" | "PAYSTACK_SUBSCRIPTION_PLAN_CODE" | "PAYSTACK_ANNUAL_SUBSCRIPTION_PLAN_CODE" | "BUYER_SUBSCRIPTION_AMOUNT_CENTS" | "BUYER_ANNUAL_SUBSCRIPTION_AMOUNT_CENTS" | "BUYER_SUBSCRIPTION_INTERVAL" | "INTRODUCTORY_FREE_DOWNLOAD_LIMIT" | "MARKETPLACE_TERMS_APPROVED" | "EDGE_CONTROLS_ATTESTED_AT" | "KEY_ROTATION_ATTESTED_AT" | "BACKUP_RESTORE_ATTESTED_AT" | "PAYMENT_PROVIDER" | "PAYMENT_ENDPOINT" | "STREAM_ACCOUNT_ID" | "STREAM_ALLOWED_ORIGINS" | "SESSION_SECRET" | "AUTH_COOKIE_DOMAIN" | "AUTH_PROVIDER" | "SUPABASE_URL" | "SUPABASE_AUDIENCE" | "AUTH_AUDIENCE" | "LOCAL_VISION_MODEL" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "REMOTE_VISION_TOKEN" | "DIDIT_API_KEY" | "PAYMENT_TOKEN" | "PAYMENT_WEBHOOK_SECRET" | "EMAIL_FROM" | "EMAIL_FROM_NAME">> {}
}

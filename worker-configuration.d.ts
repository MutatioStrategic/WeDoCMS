/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 301c024889480832853ded7033e4bb9c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ALLOWED_ORIGINS" | "TURNSTILE_HOSTNAMES" | "AUTH_COOKIE_DOMAIN" | "AUTH_PROVIDER" | "SUPABASE_URL" | "SUPABASE_AUDIENCE" | "AUTH_ALLOW_ORG_PROVISIONING" | "DEFAULT_ORGANIZATION_ID" | "RATE_LIMIT_WINDOW_SECONDS" | "RATE_LIMIT_DEFAULT_PER_WINDOW" | "UPLOAD_DAILY_QUOTA_BYTES" | "ORG_STORAGE_QUOTA_BYTES" | "MEDIA_SCANNER_URL" | "R2_BUCKET_NAME" | "R2_DR_BUCKET_NAME" | "BACKUP_BUCKET_NAME" | "CHAOS_TESTING_ENABLED" | "AUTH_JWKS_URL" | "AUTH_ISSUER" | "UPLOAD_MAX_SIZE_BYTES" | "AUDIT_SIGNING_KEY_ID" | "AUDIT_RETENTION_DAYS" | "AUDIT_ALLOWED_RESIDENCIES" | "KYC_PROVIDER" | "DIDIT_KYC_WORKFLOW_ID" | "DIDIT_KYB_WORKFLOW_ID" | "APP_PUBLIC_URL" | "CIPC_LOOKUP_URL" | "OCR_ENABLED" | "OCR_MODEL" | "PHOTO_VISION_MODEL" | "PHOTO_VISION_PROVIDER" | "REMOTE_VISION_URL" | "LOCAL_VISION_MODEL" | "PHOTO_AI_SOURCE_ORIGIN" | "R2_ACCOUNT_ID" | "PHOTO_EMBEDDING_MODEL" | "PHOTO_INDEX_NAMESPACE" | "TRENDING_SEARCH_MIN_COUNT" | "PAYOUT_MIN_CENTS" | "DEFAULT_ARTIST_SHARE_PERCENTAGE" | "PAYSTACK_SPLIT_FEE_BEARER" | "PAYSTACK_SUBSCRIPTION_PLAN_CODE" | "BUYER_SUBSCRIPTION_AMOUNT_CENTS" | "BUYER_SUBSCRIPTION_INTERVAL" | "PAYMENT_PROVIDER" | "PAYMENT_ENDPOINT" | "STREAM_ACCOUNT_ID" | "STREAM_ALLOWED_ORIGINS" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "REMOTE_VISION_TOKEN">> {}
}
